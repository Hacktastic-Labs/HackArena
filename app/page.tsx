    ...
    <div className="min-h-screen bg-white">
          ...
          <div>
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-4 -mt-1">
                <Button className="bg-[#FFB74D] text-[#A63D00] font-bold border-2 border-[#A63D00] shadow-[6px_6px_0px_0px_#000000] hover:bg-[#FFF8E1] hover:shadow-[3px_3px_0px_0px_#000000] hover:translate-x-1 hover:translate-y-1 transition-all duration-150 px-6 py-2 text-base flex items-center">
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <p className="text-xl text-gray-600 max-w-lg">
                    Synora makes it easy for both students and mentors to
                    connect, learn, and grow together through intelligent
                    matching
                  </p>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Comprehensive tools for modern mentorship
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group p-8 border-4 border-dashed border-black rounded-md hover:border-[#A63D00] transition-colors hover:bg-[#FFE8CC]">
              ...
              <p className="text-gray-600">
                AI-powered search and categorization with semantic matching
              </p>
            </div>
            ...
            <div className="group p-8 border-4 border-dashed border-black rounded-md hover:border-[#A63D00] transition-colors hover:bg-[#FFE8CC]">
              ...
              <p className="text-gray-600">
                Intelligent suggestions based on expertise and compatibility
              </p>
            </div>
            ...
            <div className="group p-8 border-4 border-dashed border-black rounded-md hover:border-[#A63D00] transition-colors hover:bg-[#FFE8CC]">
              ...
              <p className="text-gray-600">
                Seamless chat and video integration for instant help
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-[#B34700]">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-[#FFE8CC] mb-8">
            Join thousands of students and mentors already using Synora
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-white text-[#A63D00] hover:bg-transparent hover:text-white hover:border-white border-2 border-white px-8 py-4 text-lg font-bold transition-all duration-200 transform hover:scale-105 hover:shadow-[0_6px_0_0_#000]"
            >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Empowering students through intelligent mentorship connections.
              </p>
            </div>
